                            ...
                            <div class="d-flex flex-column h-100 justify-content-center">
                                <div class="auth-logo mb-4">
                                    <a href="{{ route('dashboard') }}" class="logo-dark">
                                        <img src="/images/accountagov.png" height="24" alt="logo dark">
                                    </a>

                                    <a href="{{ route('dashboard') }}"  class="logo-light">
                                        <img src="/images/accountagov.png" height="24" alt="logo light">
                                    </a>
                                </div>
                                ...
                                <div class="mb-5">
                                    <form method="POST" action="{{ route('user.login') }}" class="authentication-form">
                                        @csrf
                                        @if (sizeof($errors) > 0)
